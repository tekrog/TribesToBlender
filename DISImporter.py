...
#     bl_idname = "dynamix.dis"
#     bl_label = "Import Starsiege: Tribes .dis"
#     bl_description = 'Imports Starsiege: Tribes .dis file.'
#
#     filter_glob : StringProperty(default="*.dis", options={'HIDDEN'})
#     filename_ext = ".dis"
#
